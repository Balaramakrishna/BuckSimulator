...
public class SplashUIController extends Application{
    ...
    /**
     * Instantiates the splash screen, splash screen background image shows the
     * simulation tool capabilities.
     * Adds the icon to the simulation tool to be shown on the taskbar.
     * @param stage
     * @throws Exception 
     */
    @Override
    public void start(Stage stage) throws Exception {
        ...
        stage.getIcons().add(0,new Image(SplashScreenController.class.getResourceAsStream("/bucksimulator/images/icon_black_buck.jpeg")));
