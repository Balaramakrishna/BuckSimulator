 ...
 * Splash Screen controller, shows the splash screen and at the end displays
...
public class SplashScreenController implements Initializable
{
    ...
    void launchMainStage() throws IOException
    {
        ...
        mainStage.getIcons().add(0,new Image(SplashScreenController.class.getResourceAsStream("/bucksimulator/images/icon_black_buck.jpeg")));
        mainStage.setResizable(true);
        mainStage.setOnHidden(e -> Platform.exit());
        mainStage.setOnShowing((WindowEvent event) -> {
            controller.setInitialTheme();
	});
